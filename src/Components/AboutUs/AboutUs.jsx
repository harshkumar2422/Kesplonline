      ...
      <section className="values-section">
        <div className="container">
          ...
          <p className="subtext reveal">
            From automation to innovation our cutting-edge solutions help
          ...
          <div className="leadership-image">
            <div className="image-card reveal">
              ...
              <div className="image-overlay">
                ...
                <p className="about-social-page">
                  <Link
                    to="https://www.linkedin.com/in/paulabhinav/"
                    target="_blank"
                  >
                    Linkedin &nbsp;
                    <svg
          ...
          <div className="leadership-image">
            <div className="image-card reveal">
              ...
              <div className="image-overlay">
                ...
                <p className="about-social-page">
                  <Link
                    to="https://www.linkedin.com/in/rajanmalik/"
                    target="_blank"
                  >
                    Linkedin &nbsp;
                    <svg
